...
struct OnboardingRowInfoModel {
    ...
    struct WellcomeFeatures {
        static let calendar = OnboardingRowInfoModel(iconString: "calendar",
        ...
        static let streak = OnboardingRowInfoModel(iconString: "checkmark.seal.fill",
                                               title: "Challenge yourself",
                                               message: "For how long can you keep your floss streak? Start today you record!")
        
        static let notifications = OnboardingRowInfoModel(iconString: "alarm",
