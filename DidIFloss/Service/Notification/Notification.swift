...
extension Notification {
    ...
    ///
    /// Use the `NotificationManager` struct to request notification authorization, schedule notifications,
    ...
    struct NotificationManager {
        ...
        private static func scheduleNotification(type notification: NotificationType) {
        ...
        static func scheduleFlossRemindersNotifications() {
        ...
        static func clearAllFlossRemindersNotifications() {
